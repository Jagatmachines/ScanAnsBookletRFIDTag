...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
              <h1 align="center">Update Marks</h1><br>
              ...
              <div>
                <table class="table table-striped table-bordered">
                 ...
                 <tbody>
                  ...
                  <?php
                    $sql = "select A.USN, A.Name, A.Semester, B.Subject, B.subcode, C.MarkObtain from student_detail A, subject B, marks_table C where A.USN = C.USN AND B.subcode = C.subcode";
